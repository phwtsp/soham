...
final weeklyStatsProvider = FutureProvider.autoDispose<List<double>>((ref) async {
          ...
          children: [
            ...
            Expanded(
              child: Card(
                 ...
                 color: const Color(0xff232d37), // Cor de fundo escura para o gráfico ficar bonito
                 child: Padding(
                   padding: const EdgeInsets.only(right: 16.0, left: 0, top: 24, bottom: 12),
...
class _BarChartWidget extends StatelessWidget {
  ...
  const _BarChartWidget({Key? key, required this.data}) : super(key: key);
      ...
      BarChartData(
        ...
        titlesData: FlTitlesData(
            ...
            sideTitles: SideTitles(
              ...
              getTitlesWidget: (parsedValue, meta) {
                ...
                return Padding(
                  ...
                  child: Text(
                     DateFormat('E', 'pt_BR').format(date), // Requer initializeDateFormatting
          ...
          leftTitles: AxisTitles(
            sideTitles: SideTitles(showTitles: false), // Oculta eixo Y esquerdo para design limpo
          ),
